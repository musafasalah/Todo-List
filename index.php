    ...
    <div class="container my-3 ">  
        ...
        <div class="row d-flex justify-content-between">   
            ...
            <div class="col-md-3 "> 
                ...
                <?php $stm =  $conn->query("select * from todo where `status`='todo' order by id desc")                     ?>
            ...
            <div class="col-md-3 ">
                ...
                <?php $stm = $conn->query("select * from todo where `status`='doing' ");    ?>
            ...
            <div class="col-md-3">
                ...
                <?php $stm = $conn->query("select * from todo where `status`='done' ");    ?>
